...
import {
    ...
    Cloud, CloudOff, RefreshCw, Network, UserPlus, GitBranch, ArrowDownToLine, ArrowUpToLine, StickyNote, Database, Maximize, Minimize, Copy // <--- Network aggiunto qui
} from 'lucide-react';
...
import { NOTE_BG_PALETTES, NOTE_TEXT_PALETTES, NOTE_TEXT_COLORS, NOTE_FONTS, PRESET_THEMES, PASTEL_PALETTE, VIVID_PALETTE, NEUTRAL_PALETTE } from './config/themes';
import { GRID_SIZE, SNAP_SIZE, CANVAS_SIZE, CENTER_POS, NODE_WIDTH, NODE_HEIGHT, NODE_RADIUS, MARRIAGE_BAR_Y } from './config/constants';
